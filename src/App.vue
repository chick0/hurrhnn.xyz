<template>
    <div class="container">
        ...
        <div class="py-3 row" style="text-align:center !important">
            <img :class="col" alt="HTML is NOT a Programming Language" v-for:="url in image_url" :src="url">
        </div>

        <div class="lead py-5">
            HTML is not a programming language.
            The "<b @click="counter += 1">M</b>" stands for "Markup".
...
export default {
    setup(){
        ...
        const image_url = images[img_keys[Math.floor(Math.random() * img_keys.length)]];

        return {
            counter: counter,
            image_url: image_url,
            col: `col-md-${Number(12 / image_url.length)} col-12`
        }
    }
}
</script>
